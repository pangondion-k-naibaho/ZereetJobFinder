package com.pangondionkn.zereetjobfinder.view.advanced_ui
...
import com.pangondionkn.zereetjobfinder.databinding.LayoutSearchbarBinding
...
class InputSearchView: ConstraintLayout {
    ...
    private fun init(context: Context, attributeSet: AttributeSet?){
        ...
        binding = LayoutSearchbarBinding.bind(
            LayoutInflater.from(mContext)
                .inflate(R.layout.layout_searchbar, this, true)
        )
